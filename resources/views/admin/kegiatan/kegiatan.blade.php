...
@section('content')
    <div class="row">
        <a href="{{url("admin/kegiatan/add")}}" type="button" class="btn btn-outline-success btn-sm">
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                <p hidden="true">{{$i=1}}</p>
                @foreach($kegitan as $data)
                    <tr>
                        <th scope="row">{{$i++}}</th>
                        <td>{{$data->title}}</td>
                        <td><img src="{{ asset("/files/kegiatan/".$data->image)}}" width="75px" height="50px"/>
                        </td>
                        ...
                        <td>
                            <a href="{{url("artikel/".$data->link)}}" target="_blank">
